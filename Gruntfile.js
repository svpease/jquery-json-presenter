...
module.exports = function( grunt ) {
	...
	banner = "/*!\n" +
		" * jQuery JSON Presenter Plugin v<%= pkg.version %>\n" +
		" *\n" +
		" * <%= pkg.homepage %>\n" +
		" *\n" +
	...
	umdAdditionalDefine = "\t\tdefine( [\"jquery\", \"./jquery.jsonPresenter\"], factory );\n";
	umdLocalizationDefine = "\t\tdefine( [\"jquery\", \"../jquery.jsonPresenter\"], factory );\n";
	...
	grunt.initConfig( {
		...
		concat: {
			...
			dist: {
				...
				files: {
					"dist/jquery.jsonPresenter.js": [ "src/*.js" ]
				}
			},
			extra: {
				options: {
		...
		uglify: {
			...
			dist: {
				files: {
					"dist/jquery.jsonPresenter.min.js": "dist/jquery.jsonPresenter.js"
				}
			},
			all: {
				expand: true,
		...
		replace: {
			dist: {
				...
				replacements: [
					{
						from: "./jquery.jsonPresenter",
						to: "./jquery.jsonPresenter.min"
					}
				]
			}
		}
