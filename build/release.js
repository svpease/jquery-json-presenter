/* Release checklist
- Run `git changelog` and edit to match previous output (this should make use of jquery-release instead)
...
module.exports = function( Release ) {
	...
	Release._jsonFiles.push( "jsonPresenter.jquery.json" );
	...
	Release.define({
		...
		generateArtifacts: function( done ) {
			Release.exec( "grunt release", "Grunt command failed" );
				...
				"dist/jquery.jsonPresenter.js",
				"dist/jquery.jsonPresenter.min.js"
			]);
		},
